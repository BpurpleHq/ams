      ...
      <div className="container mx-auto px-4 py-16 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 mb-8 md:mb-0">
          <div className="relative" style={{ paddingTop: "56.25%"}}>
            <iframe
              ...
              src="https://www.youtube.com/watch?v=hHIOfiCygH0" // Replace VIDEO_ID_HERE with the actual YouTube video ID (e.g., dQw4w9WgXcQ)
        ...
        <div className="w-full md:w-1/2 text-center md:text-left ml-6">
          <h1 className="text-4xl font-bold mb-4">
            Navigate Relationships with <span className="text-teal-700">Confidence & Clarity</span>
          </h1>
