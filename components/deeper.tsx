...
const deeper: React.FC = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-teal to-gray-50 py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <div className="">
          <h1 className="text-xl md:text-4xl font-extrabold text-teal-900 mb-6 leading-tight text-teal-900 text-center">
            
              Your connection with your spouse can be deeper, but it starts with you choosing to build it on purpose
           
          </h1>
          <p className="text-lg text-gray-600 mb-4 max-w-3xl text-center">
   ...
   <p className="text-lg md:text-xl text-gray-700 mb-4 max-w-3xl">
    The conversations are still rich.   </p>
   <p className="text-lg md:text-xl text-gray-700 mb-4 max-w-3xl">
   ...
   <p className="text-lg md:text-xl text-gray-700 mb-4 max-w-3xl">
     It’s created, moment by moment, starting with how you evolve with the right mindset, emotional awareness, and shared vision.
          ...
          <div className="flex flex-col items-center">
            <a
              href="https://selar.com/deeper"
              className="inline-block bg-teal-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-teal-500 hover:text-teal-900 transition duration-300"
              // onClick={() => handleButtonClick("Secure Your Spot Now")}
            >
        ...
        {/* Why This Bootcamp */}
         ...
         <div className="mt-16">
          ...
          <p className="text-lg text-gray-600 mb-6 max-w-3xl mx-auto text-center">
            A 4-week live group experience for spouses and couples who want to expand their self awareness, deepen their 
            connection and build systems that creates an unshakable bond not just for today, but for the lifetime ahead.
        ...
        <div className="mt-16">
         ...
         <div className="mt-16">
          ...
          <p className="text-lg text-gray-600 mb-6 max-w-3xl mx-auto text-center">
            Time doesn’t make connections with stronger intentions.
The couples who thrive decades from now are the ones who invest now, while things are still “good,” so they can become even better.
You have the gift of time, don’t wait until disconnection quietly grows roots.
        ...
        {/* Event Details */}
        <div className="mt-16 bg-teal-100 py-12 px-6 rounded-lg md:flex-row text-center gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <p className="text-lg text-gray-600 mb-4">
                “We didn’t know her before and I’m usually not quick to open up to strangers, but we
                knew we needed to lay a strong foundation for our marriage. Church counselling hadn’t
                been enough, so we decided to involve a professional and that made all the difference.
                I learned to express my thoughts and feelings more intentionally...”
              </p>
              <p className="text-sm font-semibold text-teal-500">A.C. Canada</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <p className="text-lg text-gray-600 mb-4">
                “I came into the program feeling hopeless, defeated, and scared, convinced my marriage
                was beyond redemption. I wasn’t sure what to expect, but I’m so glad I took the step.
                The sessions were practical, direct, and truly addressed the real issues...”
              </p>
              <p className="text-sm font-semibold text-teal-500">C. Lagos</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <p className="text-lg text-gray-600 mb-4">
                “I was initially apprehensive and confused, but now I’m more self-aware and in touch
                with the issues in my marriage. Even my husband has noticed the ‘MrzSparkles effect’
                on me and I see it too. I’m more patient, understanding, and intentional about my
                marriage...”
              </p>
              <p className="text-sm font-semibold text-teal-500">P. Lagos</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <p className="text-lg text-gray-600 mb-4">
                “I wasn't sure if counselling would make a difference, but this program turned out to
                be a real blessing. It taught me so many valuable lessons as I started this new chapter.
                From financial responsibility to sex education in marriage, setting boundaries...”
              </p>
              <p className="text-sm font-semibold text-teal-500">Goodness, Canada</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-6 max-w-3xl mx-auto">
            The couples who thrive decades from now are the ones who invest now, while things are
            still “good,” so they can become even better. Don’t wait until disconnection quietly grows
            roots.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-6 max-w-3xl mx-auto">
            Don’t leave your future to chance. Join the Deeper Bootcamp and start
            building the marriage you envision, one that’s aligned, purposeful, and unshakable.
          </p>
